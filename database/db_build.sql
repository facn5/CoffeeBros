...
CREATE TABLE IF NOT EXISTS Places (
  ...
  google_mapID INT REFERENCES address(id) ON UPDATE CASCADE
);
...
CREATE TABLE IF NOT EXISTS Review (
  id SERIAL PRIMARY KEY,
  place_id TINYINT REFERENCES Places(id) ON UPDATE CASCADE,
...
INSER INTO pictures (place_id,pictureURL) VALUES
(1,'fattoush.jpg'),
(2,'fattoush.jpg'),
(3,'fattoush.jpg'),
(4,'fattoush.jpg'),
